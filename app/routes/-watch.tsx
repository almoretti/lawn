...
export default function WatchPage() {
      ...
      <div className="flex min-h-screen items-center justify-center bg-[#f5f5f9] p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center border-2 border-[#272357]">
              <div className="h-6 w-6 animate-spin rounded-full border-2 border-[#272357]/20 border-t-[#272357]" />
            </div>
  ...
  return (
    <div className="flex h-[100dvh] flex-col bg-[#f5f5f9]">
      {/* Header */}
      <header className="flex flex-shrink-0 items-center justify-between border-b-2 border-[#272357] bg-[#f5f5f9] px-5 py-3">
        <div className="flex items-center gap-4">
          ...
          <div className="h-4 w-[2px] bg-[#272357]/20" />
        ...
        <div className="flex items-center gap-3 text-xs text-[#6b6b8a]">
          {video.duration && (
            <>
              <span className="hidden text-[#dadae8] sm:inline">·</span>
                ...
                <DropdownMenuRadioGroup value={video.publicId}>
                  {versions.map((version) => (
                    ...
                    >
                      ...
                      {version.isLatest && <span className="ml-2 text-xs text-[#6b6b8a]">Latest</span>}
                    </DropdownMenuRadioItem>
                  ))}
                </DropdownMenuRadioGroup>
              </DropdownMenuContent>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden bg-black">
          {downloadError ? (
            <div
              ...
              aria-live="assertive"
              aria-atomic="true"
              className="border-b border-[#e50000]/40 bg-[#f8d7d7] px-5 py-3 text-sm text-[#7f1d1d]"
            >
              {downloadError}
            </div>
          ) : null}
        ...
        >
          <div className="flex flex-shrink-0 items-center justify-between border-b border-[#272357]/10 px-5 py-4">
          ...
          <div className="flex-shrink-0 border-t-2 border-[#272357] bg-[#f5f5f9] p-4">
            {isUserLoaded && user ? (
      ...
      {mobileCommentsOpen && (
        <div className="fixed inset-0 z-50 flex flex-col bg-[#f5f5f9] lg:hidden">
          ...
          <div className="pb-safe flex-shrink-0 border-t-2 border-[#272357] bg-[#f5f5f9] p-4">
            {isUserLoaded && user ? (
              <form onSubmit={handleSubmitComment} className="space-y-2">
                <div className="flex items-center gap-2 text-xs text-[#494c69]">
                  <Clock className="h-3.5 w-3.5" />
